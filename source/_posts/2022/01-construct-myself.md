...
行动计划内非核心行动总预算 9hr/d x 7d = 63hr

| 非核心行动 | 时间预算（hr） | 进度（hr） | 备注 |
| --- | --- | --- | --- |
| 科研 | 24.5 (3.5/d) | 0 | 鲸鱼算法（5.14完成大体内容） |
| 职业 | 21 (3/d) | 0 | 区块链程序（5.14初步框架） |
| --- |
| 极客 | 7 (1/d) | 0 | 为 hacks.qfstudio.net 制作自定义主题 hexo-theme-alisha |
| 游戏 | 7 (1/d) | 0 | GDQuest 学习 |
| 创作 | 3.5 (0.5/d) | 为 Lansiny 的游戏创作配乐 |
