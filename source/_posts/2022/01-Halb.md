...
- **时间** 6月27日至6月27日，共计0.5天。
- **状态** 活跃。

如果每个短期行动计划都写一句“中二”的话作为开头，那么一年我可以得到30句中二的话。
...
行动计划内非核心行动总预算 9hr/d x 0.5d = 4.5hr

| 非核心行动 | 时间预算（hr） | 实际 | 备注 |
| --- | --- | --- | --- |
| 科研 | 0 (5/d) | 0 | 完成课程任务；在导师指导的方向上学习 |
| 职业 | 0 (1.5/d) | 0 | 全套单词记忆工具；补充前端技能；发展 Go 技能 |
| --- |
| 极客 | 0 (1/d) | 0 | Akane0 制作；制作 wordpress-theme-erica 和 hexo-theme-alisha |
| 日语学习 | 0 (0.5/d) | 0 | 制作假名记忆工具和基于来自 BangDream 等歌词的记忆工具 |
| 游戏 | 4.5 (0.5/d) | 0 | Stellaris 星河战役；GDQuest 学习 |
| 创作 | 0 (0.5/d) | 0 | 写作《暗红》；为 Lansiny 的游戏创作配乐 |
