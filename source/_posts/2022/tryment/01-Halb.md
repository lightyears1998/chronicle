...
| 非核心行动 | 时间预算（hr） | 实际 | 备注 |
| --- | --- | --- | --- |
| 科研 | 2.5 (5/d) | 2.5 | 准备俄罗斯方块强化学习汇报；在导师指导的方向上学习 |
| 职业 | 0.75 (1.5/d) | 2 | dap111 区块链程序；学习先进的 kotlin 代码并完成 day-primer-android 第一版本 |
| --- |
| 极客 | 0.5 (1/d) | 0.5 | Akane0 制作；制作 wordpress-theme-erica 和 hexo-theme-alisha |
| 日语学习 | 0.25 (0.5/d) | 0.25 | 制作假名记忆工具和基于来自 BangDream 等歌词的记忆工具 |
| 游戏 | 0.25 (0.5/d) | 0.25 | GDQuest 学习 |
| 创作 | 0.25 (0.5/d) | 0.25 | 为 Lansiny 的游戏创作配乐 |
...
现今主要在食堂就餐。执行的饮食标准为早餐馒头和鸡蛋或酸奶或豆浆；午餐青菜饭类或素面；晚餐青菜素面类。注意“忌口甜食、含糖或不含糖的饮料、零食、精加工点心、油炸食品等”。
