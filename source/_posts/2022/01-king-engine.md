...
- **时间** 02月10日至02月19日，共9天。
- **目标** 进入2022年以来（同时也是建立完整方法论以来的）第一个较为全面的短期行动计划，主要目标是完成区块链项目 DappKingEngine 的初步编写。
- **状态** 活跃。
...
| --- | --- | --- | --- |
| 科研 | 0 | 0 | 寒假 |
| 极客 | 70 | 制作 DappKingEngine；制作 polymorphism-clerk |
| 工作 | 0 | 实验制作技术博客主题 |
| 创作 | 9 | Godot 围棋；Godot 象棋；制作 dkpk |
| 拓展 | 2(2/wk) | 0 | 第一探索队列 |
