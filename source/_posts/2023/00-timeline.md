...
- **9月19日** 开启《新章》短期行动计划。
- **9月20日** **语言综合** 开始通过阅读语言材料的方式学习中英日三语。
- **9月20日** **程序专精** 开始通过复刻开源软件代码练习键盘速度，并开始练习算法。
- **9月20日** **科研工作** 开始以 PIM 和 NN 为中心工作。
- **9月20日** **职业准备** 开始编写简历和完善项目。
- **9月20日** **MetaDream** 开始编写第二版本后端 API。
- **9月20日** **公开交流** 开始编写 wordpress-theme-yuu。
- **9月20日** **绘画创作** 开始设计自己的一套 UI。
- **9月20日** **音乐创作** 开始探索音色。
- **9月20日** **游戏创作** 开始研究 Godot 引擎的源代码。
