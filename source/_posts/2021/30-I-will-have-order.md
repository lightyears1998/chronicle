...
每日剩余约 12hr 可安排非核心行动，设安排效率为 0.5，则每日非核心行动时间为 6hr，行动计划周期内总计非核心行动时间预算为 6hr x 8 = 48hr。

| 非核心行动 | 时间预算（hr） | 进度（hr） | 备注 |
| --- | --- | --- | --- |
| 科研 | 27 | 0hr | |
| 工作 | 2 | 0hr | |
| 极客 | 8+3 | 0hr | 算法训练；查看 Godot 源码。 |
| 创作 | 4 | 0hr | 写作练习；tiny-army-chess |
| 拓展 | 4 | 0hr | 插空完成日语基本素质训练；《十字军之王3》塞维克斯家族 |
