...
- **时间** 10月20日至10月23日，共4天。

### 行动记录

- *10月18日* 制订短期行动计划。
- *10月19日* 原计划于17日开始执行（计划共7天），现重新调整计划开始执行时间为19日中午（共4.5天）。
- *10月19日* 调整计划开始时间为20日。
...
每日核心行动时长 12hr；余 12hr 可安排非核心行动，设安排效率为 0.5，则每日非核心行动时间为 6hr，行动计划周期内总计非核心行动时间预算为 6hr x 4 = 24hr。

| 非核心行动 | 时间预算（hr） | 进度（hr） | 备注 |
| --- | --- | --- | --- |
| 科研 | 4 | 0 | 帮导师写PCM和申报创新项目的小册子 |
