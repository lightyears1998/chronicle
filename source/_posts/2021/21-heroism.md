...
- **时间** 7月12日12时至6月17日，共计5.5天。
- **背景** 在最混乱的时刻面临真正的危险。不要预设立场，同时保持警惕：人的智慧是一切善良和恶意的根源。（中二病发）
...
- 每日核心行动时间 4hr；每日非核心行动时间 8hr；短期行动计划的效率为 0.5，预计计划期间内非核心行动时间预算为 22hr。

| 行动类别 | 时间预算 | 备注 |
| --- | --- | --- |
| 工作能力训练 | 16hr | 进行 DayPrimer 的设计和编程 |
| 创作 | 4hr | 学习使用 Blender 和 Godot，完成 Guru 教程和 Godot 文档 |
| 拓展 | 2hr | 《AoE2DE》战役与每日任务 |
