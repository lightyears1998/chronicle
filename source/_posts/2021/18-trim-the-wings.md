...
<header>
    <code>TRIM THE WINGS</code>
    <ol>
        <li><b>时间</b> 5 月 28 日起至 6 月 12 日，共计 18 天。</li>
        <li><b>目的</b> 形成“基础循环”习惯并步入研究生生活，未来可期。</li>
        <li>
            <b>行动记录</b>
            <ol>
                <li>6月4日 延长行动计划整体时间。</li>
                <li>6月4日 将年表和行动计划从个人 Github.io 迁移至 Github 独立仓库 Chronicle，此行动计划停止；后续行动转为“休整羽翼”行动计划。</li>
            </ol>
        </li>
    </ol>
</header>
...
<article>
    ...
    <div>
        <h3>基础健康</h3>
        <ol>
            <li><b>饮食</b> | 正餐和水果，避免高热量的甜食和烘焙食品。</li>
            <li><b>睡眠</b> | 保持方法论建议的每日 8 + 0.5 hr 睡眠。</li>
            <li><b>运动</b> | 每日进行中等强度运动约 1hr。</li>
        </ol>
    </div>
    <div>
        <h3>行动管理</h3>
        <p>非核心行动时间预算：56hr。</p>
        <ol>
            <li><em>40hr = 5d/week</em> <b>科研</b> 看论文和基础知识教科书。</li>
            <li><em>12hr = 1.5d/week</em> <b>极客/基础训练</b> 进行 snippet-flow 原型、架构设计及项目代码训练。</li>
            <li><em>...</em> <b>工作能力训练</b> 进行 CoolCorpus 项目。</li>
            <li><em>...</em> <b>工作能力训练</b> 形成 HTML 技术整体结构，观察和协助处理 MagicBE、PAMS 项目。</li>
            <li><em>4hr = 0.5d/week</em> <b>拓展</b> 进行各方面的能力拓展。</li>
        </ol>
    </div>
    <div>
        <h3>知识管理</h3>
    ...
    <div>
        <h4>财务管理</h4>
        <p>执行本月<a href="https://docs.google.com/spreadsheets/d/1ftaGgT0jJyCDn0CPtia2QG6WEC_Whn7KYOqOTEEo4jE/">预算</a>。</p>
    </div>
</article>
<hr />
<article>
    ...
    <div>
        ...
        <div>
            ...
            <div>
                <h4>Blender</h4>
                <p>学习并应用 Guru 的<a href="https://www.bilibili.com/video/BV1az4y1X7Tr">教程</a>。</p>
            </div>
        </div>
        <div>
            <h3>游戏</h3>
            <div>
                <h4>ReLief & TrymenT</h4>
                <p>截图与评测。</p>
            </div>
            <div>
                <h4>R.U.S.E</h4>
...
<article>
    ...
    <div>
        <h3>未来一年的规划</h3>
        <p>在研究生阶段学习算法等，圆满完成研究生阶段任务；同时发展工作技能。</p>
    </div>
    <div>
        <h3>长远规划</h3>
        <h4>职业</h4>
        ...
        <ul>
            <li>生存环境支出（房屋费用、水电费等）不超过收入的 25%；</li>
