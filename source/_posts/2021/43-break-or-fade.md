...
- **时间** 11月8日至12月11日，共4天。
- **背景** 打破二十一岁以来的迷思，进行能对长远布局形成影响的努力。
- **状态** 活跃。
...
每日核心行动时长 12hr；剩余 12hr 可安排非核心行动，设安排效率为 0.75，则每日非核心行动时间为 9hr，行动计划周期内总计非核心行动时间预算为 9hr x 4 = 36hr。

| 非核心行动 | 时间预算（hr） | 进度（hr） | 行动计划内目标 |
| --- | --- | --- | --- |
| 科研 | 24 | 0 | 每日论文；数据挖掘课程；凸优化课程；中国特色社会主义课程；复杂网络课程；算法课程；帮导师写 PCM 和申报创新项目的小册子 |
| 极客 | 4(1/d) + 2 | 0 | LeetCode 算法题训练；查看经典源码（TCL/TK） |
| 工作 | 2 | 0 | 经营 hacks.qfstudio.net：自制 Hexo 主题 hexo-theme-alisha |
| 创作 | 2(0.5/d) | 0 | 学习《新大学日语标准教程》和自由写作 |
