...
- **饮食** 食用米饭、肉类和蔬果等适宜食物；不主动食用适宜食物之外的其他食物（包括但不限于甜食、饮料、高热量食物和其他零食）。
...
每日核心行动时长 12hr；余 12hr 可安排非核心行动，设安排效率为 0.5，则每日非核心行动时间为 6hr，行动计划周期内总计非核心行动时间预算为 6hr x 10 = 60hr。

| 非核心行动 | 时间预算（hr） | 进度（hr） | 备注 |
| --- | --- | --- | --- |
| 科研 | 26 | 0hr | |
| 工作 | 4 | 0hr | 经营 hacks.qfstudio.net |
| 极客 | 20+4 | 0hr | 算法训练；查看 Godot 源码。 |
| 创作 | 3 | 0hr | 写作练习；tiny-army-chess |
| 拓展 | 3 | 0hr | 完成日语基本素质训练；将《十字军之王3》中的塞维克斯家族进行到1453年 |
...
详见[「艾莉莎」计划](https://github.com/lightyears1998/project-alisha.git)。
