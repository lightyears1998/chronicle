...
| --- | --- | --- | --- |
| 科研 | 72.5 | 0 | 每日论文；数据挖掘课程；凸优化课程；中国特色社会主义课程；复杂网络课程；算法课程；帮导师写 PCM 和申报创新项目的小册子 |
| 极客 | 11(1/d) + 2 | 0 | LeetCode 算法题训练；查看经典源码（TCL/TK） |
| 工作 | 6 | 0 | 经营 hacks.qfstudio.net：自制 Hexo 主题 hexo-theme-alisha |
| 创作 | 5.5(0.5/d) | 0 | 学习《新大学日语标准教程》和自由写作 |
