...
<header>
    <code>LEARN TO START</code>
    <ol>
        <li><b>时间</b> 5 月 16 日起至 29 日，共计 14 天。</li>
        <li><b>目的</b> 思索并形成对世界和人生的公理化认识，继续形成运用“基础循环”方法论的习惯。</li>
        <li>
            <b>行动记录</b>
            <ol>
                <li>因器材展开位置问题而决定搁置音乐练习。</li>
                <li>因时间不足而决定搁置极客基础技能训练。</li>
                <li>因时间不足无法而导入先贤的哲学观点，只能以朴素哲学暂作修补。</li>
            </ol>
        </li>
    </ol>
</header>
...
<article>
    ...
    <div>
        ...
        <p>非核心行动时间预算：88hr。</p>
        <ol>
            <li><em>88hr</em> <b>科研</b> 完成毕业设计及论文。</li>
            <li><em>未知</em> <b>核心</b> 形成公理化认识。</li>
            <li><em>（搁置）</em> <b>极客/基础训练</b> snippet-flow 原型、架构设计及项目代码。</li>
            <li><em>（搁置）</em> <b>拓展/音乐</b> MIDI 键盘练习。</li>
        </ol>
