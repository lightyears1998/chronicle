...
每日核心行动时间 4hr，核心时间预算为 32hr；每日非核心行动时间 8hr，效率为 0.5，非核心行动时间预算为 32hr。

| 行动类别 | 时间进度/预算 | 备注 |
| --- | --- | --- |
| 科研 | 0/25hr | 机器学习入门（看论文、PyTorch实战入门） |
| 创造/Blender | 0/2hr | 完成 Guru 教程 |
| 创作/Godot | 0/2hr | 完成小项目 |
| 极客 | 0/1hr | v1070笔记本改造 |
| 工作能力训练 | 0/1hr | DayPrimer 编程 |
| 拓展 | 0/1hr | 《Mount and Blade: BannerLord》 |
