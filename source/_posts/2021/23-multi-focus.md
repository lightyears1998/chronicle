...
每日核心行动时间 4hr，核心时间预算为 36hr；每日非核心行动时间 8hr，效率为 0.5，非核心行动时间预算为 36hr。

| 行动类别 | 时间进度/预算 | 备注 |
| --- | --- | --- |
| 科研 | 0/20hr | 机器学习入门（看论文、PyTorch实战入门） |
| 创造/Blender | 0/4hr | 完成 Guru 教程 |
| 创作/Godot | 0/4hr | 完成小项目 |
| 极客 | 0/4hr | v1070笔记本改造 |
