...
- **时间** 6 月 19 日至 6 月 26 日，共计 8 天。
- **背景** 规律的作息形式已不适应当前“夜不能寝”和易被打断的现状，故而需要采取灵活的作息方式。
- **目的** 形成“基础循环”习惯并步入研究生生活。

### 行动记录

- **6月19日** 制订本行动计划并开始行动，并于 12:00 开始执行。
...
- 日核心行动时间和非核心行动时间分别按 4hr 和 8hr 计；非核心行动时间预算 56hr。
- 当前的主要任务是进行工作能力训练中的 DayPrimer 项目。若以 7 天为周期，则 6 天分配于 DayPrimer 项目，1 天分配于其他拓展项目。

| 行动类别 | 时间预算 | 备注 |
| --- | --- | --- |
| 工作能力训练 | 49hr | 进行 DayPrimer 的设计和编程；学习使用 Blender 和 Godot，完成 Guru 教程和 Godot 文档。 |
| 拓展 | 8hr | 《Halo》 与《冰汽时代》 |
